  ...
  return (
    <nav style={{ background: "#2d6a0e", color: "white", padding: "0 1.5rem", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 2px 8px rgba(0,0,0,0.2)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        ...
        {/* Logo */}
        <button onClick={() => go("home")} style={{ background: "none", border: "none", color: "white", cursor: "pointer", fontSize: 18, fontWeight: 800, letterSpacing: "-0.5px" }}>
          🌿 Aruku Natural Millets
        </button>

        {/* Desktop Links */}
        <div style={{ display: "flex", gap: "1.5rem", alignItems: "center", "@media(max-width:768px)": { display: "none" } }} className="desktop-nav">
      ...
      {menuOpen && (
        <div style={{
          background: "#1a4008", padding: "0.5rem 1.5rem 1rem",
          display: "flex", flexDirection: "column", gap: 4,
          borderTop: "1px solid #3b8a14",
        }}>
          <button onClick={() => go("home")} style={btnStyle("home")}>🏠 Home</button>
      ...
      {/* CSS to hide/show desktop vs mobile nav */}
      <style>{`
